...
public class EquipeBean implements Serializable
{
   ...
   public String update()
   {
      ...
      try
      {
         ...
         else
         {
            ...
            return "view?faces-redirect=true&id=" + this.equipe.getId();
         }
      }
      catch (Exception e)
      {
   ...
   public Converter getConverter()
   {
      ...
      final EquipeBean ejbProxy = this.sessionContext.getBusinessObject(EquipeBean.class);
      ...
      return new Converter()
      {
               ...
               UIComponent component, Object value)
         {
            ...
            return String.valueOf(((Equipe) value).getId());
         }
      };
   }
